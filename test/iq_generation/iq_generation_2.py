...
class iq_generation_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "IQ Generation 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("IQ Generation 2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "iq_generation_2")
        ...
        # Variables
        ##################################################
        self.t_vals = t_vals = numpy.arange(-512,512)/32
        ...
        self._fc_range = qtgui.Range(2500, 10000, 1, 3000, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "Carrier Freq Slider", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f(numpy.sinc(t_vals)**2 * numpy.sinc(t_vals) * -numpy.pi, True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f(numpy.sinc(t_vals), True, 1, [])
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        ...
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 1))
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 1))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0_0_0, 1))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 2))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 2))
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 3))
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 3))
    ...
    def set_t_vals(self, t_vals):
        self.t_vals = t_vals
        self.blocks_vector_source_x_0.set_data(numpy.sinc(self.t_vals), [])
        self.blocks_vector_source_x_0_0.set_data(numpy.sinc(self.t_vals)**2 * numpy.sinc(self.t_vals) * -numpy.pi, [])
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=iq_generation_2, options=None):
