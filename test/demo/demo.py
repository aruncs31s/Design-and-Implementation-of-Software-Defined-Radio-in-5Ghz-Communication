...
class demo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "demo")
        ...
        # Variables
        ##################################################
        self.t_vals = t_vals = np.arange(-512,512)/32
        ...
        self._fc_range = qtgui.Range(1e3, 1e6, 1, 1e3, 200)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_f(np.sinc(t_vals), True, 1, [])
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1.414, 0, 0)
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_t_vals(self, t_vals):
        self.t_vals = t_vals
        self.blocks_vector_source_x_0.set_data(np.sinc(self.t_vals), [])
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_RECTANGULAR, 6.76))
