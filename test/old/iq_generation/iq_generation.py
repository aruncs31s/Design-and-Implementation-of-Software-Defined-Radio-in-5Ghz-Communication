...
class iq_generation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "IQ Signal Generation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("IQ Signal Generation")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "iq_generation")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f(numpy.sinc(t_vals)**2, True, 1, [])
    ...
    def set_t_vals(self, t_vals):
        ...
        self.blocks_vector_source_x_0_0.set_data(numpy.sinc(self.t_vals)**2, [])
...
def main(top_block_cls=iq_generation, options=None):
