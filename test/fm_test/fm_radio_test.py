...
class fm_radio_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_radio_test")
        ...
        self.iio_pluto_source_0.set_frequency(int(93.5e6))
        self.iio_pluto_source_0.set_samplerate(int(1e6))
