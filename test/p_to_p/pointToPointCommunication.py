...
class pointToPointCommunication(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Point To Point Communication", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Point To Point Communication")
        ...
        self.fc = fc = int(2e9)
        self.bandpass_freq = bandpass_freq = int(2e3)

        ##################################################
        # Blocks
        ##################################################

        self._fc_range = qtgui.Range(int(1e9), int(6e9), 1, int(2e9), 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "'fc'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._bandpass_freq_range = qtgui.Range(int(1e3), int(6e3), 1, int(2e3), 200)
        self._bandpass_freq_win = qtgui.RangeWidget(self._bandpass_freq_range, self.set_bandpass_freq, "Signal Source Range", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._bandpass_freq_win)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, bandpass_freq, 1.414, 0, 0)
    ...
    def set_bandpass_freq(self, bandpass_freq):
        ...
        self.analog_sig_source_x_0.set_frequency(self.bandpass_freq)




def main(top_block_cls=pointToPointCommunication, options=None):
