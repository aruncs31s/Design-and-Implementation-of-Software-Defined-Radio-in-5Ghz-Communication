...
class pkt_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Packet Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet Receiver")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pkt_rx")
...
def main(top_block_cls=pkt_rx, options=None):
