...
class pkt_transmitt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.connect((self.blocks_uchar_to_float_0_0_0_0, 0), (self.blocks_throttle2_0, 0))
    ...
    def set_pluto_rate(self, pluto_rate):
        ...
        self.mmse_resampler_xx_0.set_resamp_ratio((1.0/((self.pluto_rate/self.samp_rate)*self.rs_ratio)))
        self.qtgui_time_sink_x_1.set_samp_rate(self.pluto_rate)
