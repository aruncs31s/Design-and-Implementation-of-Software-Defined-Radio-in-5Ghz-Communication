...
class qpsk_with_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_with_pluto")
...
def main(top_block_cls=qpsk_with_pluto, options=None):
    if options is None:
