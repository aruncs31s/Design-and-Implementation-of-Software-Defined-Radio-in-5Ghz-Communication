...
class qpsk_with_pluto_rx(gr.top_block, Qt.QWidget):

    def __init__(self, InFile='default'):
        gr.top_block.__init__(self, "QPSK With Pluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK With Pluto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_with_pluto_rx")
        ...
        self.qtgui_time_sink_x_0_2_1.set_y_axis(-0.1, 1.1)

        self.qtgui_time_sink_x_0_2_1.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_2_1.enable_tags(True)
        self.qtgui_time_sink_x_0_2_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.2, 0.0, 0, "packet_len")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_2_1_win, 1, 0, 1, 2)
        for r in range(1, 2):
        ...
        self.iio_pluto_source_0.set_frequency(int(5e9))
        self.iio_pluto_source_0.set_samplerate(usrp_rate)
        ...
        self.connect((self.blocks_uchar_to_float_0_0_2, 0), (self.qtgui_time_sink_x_0_2_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_uchar_to_float_0_0_1_0, 0))
        ...
        self.connect((self.digital_diff_decoder_bb_0, 0), (self.blocks_uchar_to_float_0_0_2, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.iio_pluto_source_0.set_samplerate(self.usrp_rate)
...
def main(top_block_cls=qpsk_with_pluto_rx, options=None):
    if options is None:
