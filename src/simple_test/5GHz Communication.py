...
class 5GHz Communication(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "5GHz Communication")
...
def main(top_block_cls=5GHz Communication, options=None):
