...
class mix(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/aruncs/Git/Design-and-Implementation-of-Software-Defined-Radio-in-5Ghz-Communication/src/perfomance_analysis/QPSK/message_2.txt', False, 0, 0)
...
def main(top_block_cls=mix, options=None):
    if options is None:
