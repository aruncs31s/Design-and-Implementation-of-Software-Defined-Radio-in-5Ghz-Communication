...
import bpsk_mix_new_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class bpsk_mix_new(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "bpsk_mix_new")
        ...
        self.pluto_rate = pluto_rate = 768000
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=1,
                decimation=((int)(pluto_rate/samp_rate)),
                taps=[],
                fractional_bw=0)
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.mmse_resampler_xx_0 = filter.mmse_resampler_cc(0, (1.0/((pluto_rate/samp_rate)*rs_ratio)))
        ...
        self.blocks_throttle2_0_0 = blocks.throttle( gr.sizeof_gr_complex*1, pluto_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * pluto_rate) if "auto" == "time" else int(0.1), 1) )
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.mmse_resampler_xx_0.set_resamp_ratio((1.0/((self.pluto_rate/self.samp_rate)*self.rs_ratio)))
    ...
    def set_pluto_rate(self, pluto_rate):
        ...
        self.blocks_throttle2_0_0.set_sample_rate(self.pluto_rate)
        self.mmse_resampler_xx_0.set_resamp_ratio((1.0/((self.pluto_rate/self.samp_rate)*self.rs_ratio)))
...
def main(top_block_cls=bpsk_mix_new, options=None):
