...
import pkt_transmitt_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class pkt_transmitt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pkt_transmitt")
        ...
        self.iio_pluto_sink_0.set_samplerate(int(576e3))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.iio_pluto_sink_0, 0))
...
def main(top_block_cls=pkt_transmitt, options=None):
    if options is None:
